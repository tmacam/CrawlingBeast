...
set output "20070506-min.eps"
set border
set yrange [1:10000]
set logscale y
#"20070506-min.data" u 1:2 t "Descobertas" w lines ,
plot	\
	"20070506-min.data" u 1:3 t "Visitadas" w lines,\
	"20070506-min.data" u 1:4 w lines t "Recuperadas" 
